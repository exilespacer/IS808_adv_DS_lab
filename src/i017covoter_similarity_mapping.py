...
covoting_between_voters = data_dir / "covoting_between_voters.pq"
...
output_file = "similarity_covoting_mapping_final_data_set.pq"
...
df_covoting_between_voters = pd.read_parquet(covoting_between_voters)
...
# %%
df_covoting_between_voters.info()

df_covoting_between_voters.info()
len(df_covoting_between_voters.index)
...
merged1 = pd.merge(df_dao_voter_similarity_binary,df_covoting_between_voters, how='left', left_on=['voter1', 'voter2'], right_on=['voter1', 'voter2']).fillna(0)
