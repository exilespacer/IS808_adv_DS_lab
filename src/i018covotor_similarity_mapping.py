...
output_file = "covotor_similarity_mapping.pq"

# %% Read Data sets
df_dao_voters_similarity_votechoice_binary = pd.read_parquet(dao_voters_similarity_votechoice_binary)
df_dao_voters_similarity_votechoice_binary.columns = ['voter1', 'voter2', 'share_choices']
df_dao_voters_similarity_votechoice_numeric = pd.read_parquet(dao_voters_similarity_votechoice_numeric)
df_dao_voters_similarity_votechoice_numeric.columns = ['voter1', 'voter2', 'number_shared_choices']
...
# %% Merge data set
merged1 = pd.merge(df_dao_voters_similarity_votechoice_binary,df_dao_voters_similarity_votechoice_numeric, how='left', left_on=['voter1', 'voter2'], right_on=['voter1', 'voter2']).fillna(0)
